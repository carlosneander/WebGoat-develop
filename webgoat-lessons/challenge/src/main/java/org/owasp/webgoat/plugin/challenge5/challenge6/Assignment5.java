...
public class Assignment5 extends AssignmentEndpoint {
    ...
    public AttackResult login(@RequestParam String username_login, @RequestParam String password_login) throws Exception {
        ...
        string query = "select password from ? where userid = ? and password = ?";
        PreparedStatement stmt = con.createStatement(query);
        stmt.setString(1, USERS_TABLE_NAME);
        stmt.setString(2, username_login);
        stmt.setString(3, password_login);
